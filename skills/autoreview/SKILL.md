...
"$AUTOREVIEW" --panel --codex-profile bedrock
...
| `AUTOREVIEW_CODEX_PROFILE`         | Named Codex profile staged into the isolated runtime; currently supports `amazon-bedrock` profiles                              |
